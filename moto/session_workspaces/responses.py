...
from .exceptions import SESSValidationError
...
class TokenResponse(BaseResponse):
    def get_session_token(self):
        ...
        token = sess_backend.get_session_token(duration=duration)
    ...
    def get_federation_token(self):
        ...
        token = sess_backend.get_federation_token(
